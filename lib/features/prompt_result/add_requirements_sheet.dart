...
class AddRequirementsSheet extends ConsumerStatefulWidget {
  final String promptId;
  final String currentContent;

  const AddRequirementsSheet({super.key, required this.promptId, required this.currentContent});

  @override
  ConsumerState<AddRequirementsSheet> createState() => _AddRequirementsSheetState();
}

class _AddRequirementsSheetState extends ConsumerState<AddRequirementsSheet> {
  ...
  Future<void> _enhance() async {
    if (_ctrl.text.trim().isEmpty) {
      SnackbarUtils.showError(context, 'Please describe the requirements to add');
      return;
    }
    ...
    try {
      ...
      final result = await api.enhancePrompt(widget.promptId, _ctrl.text.trim());
      ...
      if (mounted) SnackbarUtils.showError(context, 'Failed to enhance prompt. Please try again.');
    } finally {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  const Icon(Icons.add_circle_rounded, color: AppColors.secondary, size: 22),
                  const SizedBox(width: 10),
                  const Text('Add Requirements', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700)),
                  const Spacer(),
                  Container(
            ...
            const Padding(
              ...
              child: Text(
                'Describe additional requirements to add to the prompt',
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'e.g., Add biometric authentication, offline mode, multi-language support...',
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            onPressed: _isLoading ? null : _enhance,
                            child: _isLoading
